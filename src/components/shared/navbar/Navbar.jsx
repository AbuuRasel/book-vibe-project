        ...
        <div className="navbar-start">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn lg:hidden">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="#23BE0A" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /> </svg>
            </div>
            <ul
              tabIndex="-1"
              className="menu menu-sm dropdown-content bg-white border border-gray-100 shadow-lg rounded-box z-10 mt-3 w-52 p-2">
              {links}
            </ul>
          </div>
          <h2 className="text-xl font-bold ml-3 cursor-pointer">Book Vibe</h2>
        </div>
